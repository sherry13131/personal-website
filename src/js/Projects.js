                ...
                <div className="projects-top">
                    ...
                    <div className="project-box">
                        <div className="pcol pleft">
                            ...
                            <div>
                                <h2 className="ph2"><a className="project-btn custom-underline" id="minesweeper" target="_blank" rel="noopener noreferrer" href="https://github.com/sherry13131/Minesweeper-Java">Minesweeper</a></h2>
                                <p>- Remake traditional game minesweeper in Java</p>
                                <p>- Simple game control and clean menu</p>
                                <p>- Different levels are available</p>
                            </div>
